...
vi.mock('@/lib/api', () => ({ getCurrentVenueAccount: vi.fn(async () => ({ id: 'v1', pin: '0000' })) }));
vi.mock('react-icons/md', () => ({ MdOutlineMeetingRoom: () => React.createElement('span', null, 'icon') }));
...
vi.mock('@/components/shared/dogo-ui', () => ({ DogoCard: ({ children }: any) => React.createElement('div', null, children), DogoButton: (props: any) => React.createElement('button', { ...props }, props.children) }));
